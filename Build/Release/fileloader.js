...
(function() {
 var loadPackage = function(metadata) {
    ...
    var REMOTE_PACKAGE_NAME = typeof Module['locateFile'] === 'function' ?
      ...
      var REMOTE_PACKAGE_SIZE = 8211215;
      var PACKAGE_UUID = '2b548852-fa24-43eb-aafb-1451e4b6604b';
...
Module['FS_createPath']('/', 'Resources', true, true);
    ...
    new DataRequest(22848, 22867, 0, 0).open('GET', '/methods_pointedto_by_uievents.xml');
    new DataRequest(22867, 4613231, 0, 0).open('GET', '/sharedassets0.assets');
    new DataRequest(4613231, 5815315, 0, 0).open('GET', '/Il2CppData/Metadata/global-metadata.dat');
    new DataRequest(5815315, 7707331, 0, 0).open('GET', '/Resources/unity_default_resources');
    new DataRequest(7707331, 8211215, 0, 0).open('GET', '/Resources/unity_builtin_extra');
